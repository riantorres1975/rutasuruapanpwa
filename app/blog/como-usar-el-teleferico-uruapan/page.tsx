...
export const metadata: Metadata = {
  title: "CÃ³mo usar el TelefÃ©rico de Uruapan paso a paso",
  description:
    "GuÃ­a completa para usar el TelefÃ©rico de Uruapan: tarjeta de movilidad, tarifa por viaje, estaciones, horario y combinaciÃ³n con camiones urbanos.",
  alternates: {
    canonical: "https://www.urugo.app/blog/como-usar-el-teleferico-uruapan"
  },
  openGraph: {
    title: "CÃ³mo usar el TelefÃ©rico de Uruapan paso a paso",
    description: "Tarjeta de movilidad, tarifa, estaciones, horario y tips para combinar el TelefÃ©rico con camiones urbanos.",
...
const blogPostingJsonLd = {
  ...
  "@type": "BlogPosting",
  headline: "CÃ³mo usar el TelefÃ©rico de Uruapan paso a paso",
  description: "GuÃ­a completa para usar el TelefÃ©rico de Uruapan: tarjeta de movilidad, tarifa por viaje, estaciones, horario y combinaciÃ³n con camiones urbanos.",
  ...
  inLanguage: "es-MX",
  keywords: "telefÃ©rico Uruapan, cÃ³mo usar telefÃ©rico, tarjeta movilidad Uruapan, estaciones telefÃ©rico, horario telefÃ©rico"
};
...
const SECTIONS = [
  {
    n: "01",
    title: "QuÃ© es el TelefÃ©rico",
    body: "El TelefÃ©rico de Uruapan es un sistema de transporte urbano que conecta zonas clave de la ciudad mediante estaciones elevadas. En UruGo aparece integrado con rutas de camiÃ³n para planear viajes multimodales."
  },
  {
    n: "02",
    title: "CÃ³mo obtener la tarjeta de movilidad",
    body: `Para usar el TelefÃ©rico necesitas una tarjeta electrÃ³nica de movilidad. Como referencia se muestra un costo de ${FARES_2026.mobilityCard.price}. Conserva la tarjeta para recargarla y validar futuros accesos.`
  },
  {
    n: "03",
    title: "CÃ³mo validar el acceso",
    body: `Al entrar a la estaciÃ³n, acerca tu tarjeta al validador. Cada viaje cuesta ${TELEFERICO_URUAPAN.fare}. Si tambiÃ©n usas camiÃ³n urbano, considera cada abordaje por separado al calcular tu presupuesto.`
  },
  {
    n: "04",
    title: "Horario",
    body: `Opera de ${TELEFERICO_URUAPAN.hours} todos los dÃ­as. Revisa avisos oficiales antes de viajar, especialmente en dÃ­as festivos o por mantenimiento programado.`
  },
  {
    n: "05",
    title: "Tips para combinarlo con camiÃ³n",
    body: "Marca tu origen y destino en el mapa para ver si te conviene llegar a una estaciÃ³n caminando, en camiÃ³n o con transbordo. El TelefÃ©rico puede ser Ãºtil para cruzar de oriente a poniente y despuÃ©s completar el trayecto en ruta urbana."
  }
] as const;
    ...
    <main className="greca-bg greca-bg-animated min-h-dvh px-5 py-8 sm:px-8 lg:px-10" style={{ background: "#0c110a", color: "#e8f2d8" }}>
      ...
      <article className="relative z-10 mx-auto max-w-3xl">
        <PageHeader
          backHref="/blog"
          backLabel="Blog"
          kicker="ÃšnicÐ¾ en MichoacÃ¡n"
          eyebrow="GuÃ­a 2026"
          title={
            <>
              CÃ³mo usar el <span className="italic text-lima">TelefÃ©rico</span> de Uruapan paso a paso.
            </>
          }
          intro="Aprende cÃ³mo abordar, pagar y combinar el TelefÃ©rico de Uruapan con rutas de camiÃ³n urbano desde UruGo."
        />
