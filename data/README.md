...
`rutas_produccion_final.json` contiene los recorridos verificados que utiliza UruGo. Los puntos de referencia de la Ruta 1 y las estaciones del Teleferico fueron verificados manualmente. Las propuestas para las demas rutas se generan con `pnpm landmarks:review` y se aplican con `pnpm landmarks:apply`.
